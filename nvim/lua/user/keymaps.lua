...
nnoremap("<leader>gg", "<cmd>LazyGit<cr>", { desc = "Lazygit", silent = true })
...
nnoremap("<leader>a", require("telescope.builtin").live_grep, { desc = "[S]earch by [G]rep" })
